...
prob.add_state('x', 'v * cos(gam) * sin(psi) + beta*z+W_0')
...
guess = giuseppe.guess_generation.auto_propagate_guess(comp_prob, control= np.array((Cl_guess, sig_guess)),
                                                       p= np.array((0.08, 100,-.005, 0)), t_span=5, initial_states=np.array((x_0, y_0, z_0, 100,-.005, 0)))
...
cont.add_linear_series(100, {'z_f': z_f, 'v_f': v_f})
